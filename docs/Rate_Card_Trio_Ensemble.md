...
Traditional Spanish flamenco featuring guitarist, cajón percussion, and professional flamenco dancer.

**Best for:** Specialty cultural nights, signature experiences, Mediterranean venues, Spanish/Baja-coastal concepts  
**Energy:** Contemplative to high-energy depending on configuration  
**Footprint:** 12'×12' minimum; dancer requires smooth, stable surface (stage preferred)  
**Lead time:** Solo/duo 2-3 weeks; with dancer 4-6 weeks

### B2C Pricing — Flamenco Trio Full (Dancer Entire Duration)
...
### B2C Pricing — Flamenco Trio Hybrid (Recommended Default)

Structure: 2-3 hours total service with dancer featured for key portion only (typically final hour).

**Positioning:** Marketed as "Flamenco Trio" but delivered as duo (dinner service) + full trio (featured flamenco performance). Dancer transforms background music into experiential moment.

**When to use:** Default delivery model for flamenco trio bookings unless client explicitly requests dancer for full duration.

#### 2-Hour Service / Dancer 1 Hour
...
Traditional Mexican ensemble with violins, trumpets, guitars (guitarrón, vihuela), vocals.

**Best for:** Weekend activations, holiday programming, cultural celebrations, Cinco de Mayo  
**Energy:** Celebratory, authentic  
**Footprint:** 12'×12' minimum for full group  
**Lead time:** 4-6 weeks; Cinco de Mayo/holidays 8+ weeks

**Note:** Mario Eguia's ensemble — San Diego's premier traditional Mariachi. Authentic repertoire, not "mariachi-themed" covers.

### B2C Pricing — San Diego County

**2-Hour Service (Minimum):**
...
### B2C Pricing — Outside San Diego County

**3-Hour Minimum (travel built in):**
...
**Footprint:** 10'×10' minimum  
**Lead time:** 3-4 weeks

**Position as:** Right-sized for the setting, not a budget alternative to full ensemble.
...
**1-Hour Service:**  
T2P $850 / $775 | T2D $950 / $875 | T3P $1,000 / $900 | T3D $1,100 / $1,000
...
**1-Hour Service:**  
T2P $1,100 / $1,000 | T2D $1,250 / $1,150 | T3P $1,350 / $1,250 | T3D $1,500 / $1,375
...
**1-Hour Service:**  
T2P $1,395 / $1,275 | T2D $1,500 / $1,375 | T3P $1,600 / $1,475 | T3D $1,800 / $1,650
...
**Bolero Trio:** See Rate_Card_Bolero_Trio.md (separate rate card)  
**Programming details:** See Programming_Catalog  
**Positioning language:** See Strategic_Positioning, Copy_Bank  
