...
**Strong triggers (any ONE sufficient):**
- Heritage explicitly mentioned ("Spanish family," "Mexican heritage," "honoring traditions")
- Cultural guest demographics stated ("half the room will be Spaniards")
- Milestone celebration for elder (70th, 80th, 90th birthday; 50th anniversary)

**Supporting triggers (need 2+):**
- Traditional music genre with emotional weight
- Language suggesting cultural transmission ("passing down," "honoring")
- Cultural venue or context clues

**If Cultural Context active:**
→ Load appropriate CULTURAL_[region].md file
→ Apply 5-component cultural framework from CULTURAL_CORE.md
→ Do NOT use Social Proof technique (cultural expertise differentiates instead)

### Planner Effort Layer

**Triggers (any ONE):**
- Detailed song list (10+ songs)
- Explicit vibe articulation with personality
- Multiple specific requirements showing forethought
- Language indicating they've considered guest experience

**If Planner Effort active:**
Weave validation throughout response:
- "I can tell you've put real thought into this."
- "Your guests will feel how much care went into this."
- Reference a specific detail they provided.

### Social Proof Technique

**Apply ONLY when ALL conditions met:**
- Tier is Standard OR Qualification (per PROTOCOL.md → Step 4)
- Cultural Context is NOT active
- Urgency is NOT present
- Competition is Low or Medium

**Pattern:** Reframe recommendations as observed patterns.
...
## Step 7: Address Flagged Concerns

Every flagged concern requires **integrated proof**—concern, experience, and solution in adjacent sentences.

### Integration Requirement

**Wrong (scattered):**
> I've performed at the Lodge many times.
> [paragraphs later]
> I carry backup equipment.

**Right (integrated):**
> I've performed at the Lodge many times, including outdoor events without cover. I carry backup equipment and arrive early to calibrate for the space.

### Common Concern Patterns

| Concern | Integrated Response |
|---------|---------------------|
| Outdoor / no cover | "I've performed outdoor events without cover many times. I carry backup equipment for weather and arrive early to calibrate." |
| Equipment uncertainty | "I'm fully self-contained—I bring everything needed, including professional sound." |
...
## Step 8: Find the Wedge

**The wedge is the ONE insight that creates separation from every other response.**

It lands in your first 1-2 sentences.
