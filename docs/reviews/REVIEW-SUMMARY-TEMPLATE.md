...
```text
Read HANDOFF.md, CLAUDE.md, and docs/reviews/CODEX-REVIEW-GATE.md. Fix the review findings in [files]. Keep scope limited to the listed findings. Run the required checks and stop after updating the relevant handoff or review docs.
```
