...
**Recommend Trio when:**
- Client requests "Flamenco Group" or "Flamenco Band"
- Client mentions guests will be dancing (participatory, not watching)
- Spanish or European guests specifically mentioned
- Two-phase event described (dinner → dance party)
- "Gypsy Kings" style with dance emphasis
- Juerga-style celebration indicated

**Recommend Duo (no dancer) when:**
- Client wants flamenco sound but emphasizes background music
- Space constraints make dancer impractical (under 15' x 6')
