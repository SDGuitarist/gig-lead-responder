...
1. Task kieran-typescript-reviewer(PR diff + metadata) — TypeScript code quality, naming, idiomatic patterns
...
**batch3 — Data, History & Deployment (3 agents)**
...
3. Task deployment-verification-agent(PR diff + metadata) — Pre/post-deploy checklist, rollback procedures
...
### Batches Remaining:
- [ ] batch1 — Code Quality (kieran-typescript, pattern-recognition, code-simplicity)
- [ ] batch2 — Architecture & Security (architecture, security, performance)
- [ ] batch3 — Data & Deployment (data-integrity, git-history, deployment)
...
|-------|--------|----------|
| batch1 | kieran-typescript, pattern-recognition, code-simplicity | X |
| batch2 | architecture, security, performance | X |
| batch3 | data-integrity, git-history, deployment | X |
...
6. **Three questions are mandatory** — synthesize step ends with three questions in REVIEW-SUMMARY.md
...
/review-batched batch3            # Third: data & deployment
